...
politicas = 'Nós temos foco em grandes empresas com potencial de inovação'

# Exemplo de uso, substitua "Lojas Americanas" pelo nome da empresa que deseja analisar
